...
def load_data():
    light_unit_lookup = load_csv_dict("StandardindicatingLightLEDlightUnit 2.csv")
    lens_lookup = load_csv_dict("StandardIndicatingLightLEDLens 2.csv")
    voltage_lookup = load_csv_dict("IndicatinglightLEDvoltage 3.csv")
